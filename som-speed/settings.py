...
WEBSITE_NAME = "SOM: Simple Object Machine" # This name will be used in the reports RSS feed

DEF_ENVIRONMENT = "Infinity" #Name of the environment which should be selected as default
...
DEF_EXECUTABLE = ("TruffleSOM", "TruffleSOM-graal") # Executable that should be chosen as default in the changes view
...
COMP_EXECUTABLES = [('RPySOM-jit', 'L'),
                    ('TruffleSOM', 'L'),
                    ('SOMpp',      'L') ]  # Which executable + revision should be checked as default
