...
WEBSITE_NAME = "Are We Fast Yet: Cross-Language Compiler Benchmarking" # This name will be used in the reports RSS feed

DEF_ENVIRONMENT = "Infinity Ubuntu" #Name of the environment which should be selected as default


DEF_BASELINE = {'executable': 'Java8U66'} # Which executable + revision should be default as a baseline
...
DEF_EXECUTABLE = 'Java8U66' # Executable that should be chosen as default in the changes view
...
COMP_EXECUTABLES = [#('SOMns-graal',  'L'),
                    ('SOMns-interp', 'L'), ]  # Which executable + revision should be checked as default
