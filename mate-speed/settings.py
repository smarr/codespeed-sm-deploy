...
DEF_ENVIRONMENT = "mostaza" #Name of the environment which should be selected as default
...
COMP_EXECUTABLES = [('TruffleMate', 'L'),
                    ('TruffleSOM',  'L') ]  # Which executable + revision should be checked as default
...
DEF_BRANCH = "SOMwithTheOSM" # Defines the default branch to be used.
